...
Copy folders 
LCK and FinalLog
into the SpiderExperiment[Version]_Data folder upon 
Copey the readme files into the root folder 
BUT NOT the developer readme files, which participants are not allowed to see.

Please heed the notes at the top of most scripts. For further questions contact 
Joseph Given at
info@given-communication.de
To acces the experiment for test purposes use the password "99test"
...
under supervision of Professor Fredrik Ähs, Mid Sweden University Department of Psychology and Social Work, fredrik.ahs@miun.se
