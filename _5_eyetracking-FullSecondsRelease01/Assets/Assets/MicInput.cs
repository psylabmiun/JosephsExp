...
public class MicInput : MonoBehaviour
{
    ...
    #endregion
    //Main script by user "A_munim" (forum.unity.com/threads/check-current-microphone-input-volume.133501/) 
    //with fine tuning by Bryan Lester, 04/02/2019 (www.youtube.com/watch?v=y_efMcPcyNM) and Joseph Given, author of the experiment

    public static float MicLoudness;
    public static float MicLoudnessinDecibels;
    public static float db = 20 * Mathf.Log10(Mathf.Abs(MicInput.MicLoudness));
    ...
    /*    public void InitMic()
        ...
        public static AudioClip _recordedClip;
