...
if ($_SERVER['REQUEST_METHOD'] === "POST") {
    ...
    $mailtext = "Thank you for taking part in our test. Below you will find the answers you have given us. We will be in touch shortly with the results of your test";
    ...
    mail(
    	...
    	$mailtext,
    	implode("\n", $header)
    ) or die("Your mail was not sent to Given Communication.");    
	{
echo "<p><span class='colorTextBlue'>E-mail sent successfully</span></p>";
echo "<p>Thanks for your time. We will be in touch with you shortly.</span></p>";
echo 'Click <a href="http://www.given-communication.de/">here</a> to go back to <a href="http://www.given-communication.de/">www.given-communication.de</a>';
